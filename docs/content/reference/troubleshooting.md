...
Most of these come down to network reality or how cyberleninka serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

cyberleninka rate-limits like any public site. cyber already paces
...
Where a surface is gated, cyber reads a cookie or token you supply
...
`cyber`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cyber actually did
